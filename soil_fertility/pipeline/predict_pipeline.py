...
def fix_columns_name(data):
    names= ['N', 'P', 'K', 'pH', 'EC', 'OC', 'S', 'Zn', 'Fe', 'Cu', 'Mn', 'B', 'OM', 'Fertility']
    data.columns = names
    return data
...
class PredictPipeline:
    ...
    def predict(self, features, model_name : str ):
        try : 
            ...
            all_processor_path = os.path.join(self.preprocessors_path, "all_features_pipeline.pkl")
            preprocessor_path = os.path.join(self.preprocessors_path, "preprocessor_first.pkl")
